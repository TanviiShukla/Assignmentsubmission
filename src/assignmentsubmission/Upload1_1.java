 ...
 * @author Siddharth
 */
public class Upload1_1 extends javax.swing.JFrame {
...
try {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Upload1_1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
